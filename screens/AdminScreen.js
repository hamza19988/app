    ...
    <View style={styles.container}>
      ...
      <View style={[styles.sideMenu, menuOpen ? styles.sideMenuOpen : styles.sideMenuClosed]}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.menuButtonText}>Global Dash Staffing</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        <TouchableOpacity
          style={[styles.menuButton, activeButton === 'BT' && styles.activeButton]}
          onPress={() => handleButtonPress('BT')}>
          <Ionicons name="business-outline" size={24} color="#fff" />
        ...
        <TouchableOpacity
          style={[styles.menuButton, activeButton === 'button 7' && styles.activeButton]}
          onPress={() => handleButtonPress('button 7')}>
          <Ionicons name="business-outline" size={24} color="#fff" />
          <Text style={styles.menuButtonText}>LO</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.menuButton, activeButton === 'button 8' && styles.activeButton]}
          onPress={() => handleButtonPress('button 8')}>
          <Ionicons name="business-outline" size={24} color="#fff" />
          <Text style={styles.menuButtonText}>RE</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.menuButton, activeButton === 'button 9' && styles.activeButton]}
          onPress={() => handleButtonPress('button 9')}>
          <Ionicons name="business-outline" size={24} color="#fff" />
